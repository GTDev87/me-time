...
while (G__18641__i < G__18641__a.length) {G__18641__a[G__18641__i] = arguments[G__18641__i + 0]; ++G__18641__i;}
  args = new cljs.core.IndexedSeq(G__18641__a,0);
} 
return re_frame$middleware$path__delegate.call(this,args);};
re_frame$middleware$path.cljs$lang$maxFixedArity = 0;
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__18642){
...
return cljs.core.get_in.call(null,new_db,p1__18643_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__18644_SHARP_){
return cljs.core.get_in.call(null,db,p1__18644_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
var G__18645__i = 0, G__18645__a = new Array(arguments.length -  2);
while (G__18645__i < G__18645__a.length) {G__18645__a[G__18645__i] = arguments[G__18645__i + 2]; ++G__18645__i;}
  in_paths = new cljs.core.IndexedSeq(G__18645__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__18646){
var f = cljs.core.first(arglist__18646);
arglist__18646 = cljs.core.next(arglist__18646);
var out_path = cljs.core.first(arglist__18646);
var in_paths = cljs.core.rest(arglist__18646);
