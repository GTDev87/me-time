...
var args18591 = [];
var len__17884__auto___18595 = arguments.length;
var i__17885__auto___18596 = (0);
while(true){
if((i__17885__auto___18596 < len__17884__auto___18595)){
args18591.push((arguments[i__17885__auto___18596]));

var G__18597 = (i__17885__auto___18596 + (1));
i__17885__auto___18596 = G__18597;
continue;
} else {
}
break;
...
var handler_fn = cljs.core.get.call(null,cljs.core.deref.call(null,re_frame.subs.key__GT_fn),key_v);
if(goog.DEBUG){
var temp__4425__auto___18599 = cljs.core.seq.call(null,cljs.core.remove.call(null,((function (key_v,handler_fn){
return (function (p1__18590_SHARP_){
if(!((p1__18590_SHARP_ == null))){
if((false) || (p1__18590_SHARP_.reagent$ratom$IReactiveAtom$)){
return true;
} else {
return false;
}
...
,dynv));
if(temp__4425__auto___18599){
var not_reactive_18600 = temp__4425__auto___18599;
re_frame.utils.warn.call(null,"re-frame: dynv contained parameters that don't implement IReactiveAtom: ",not_reactive_18600);
} else {
}
} else {
}
